...
<html>
    ...
    <body>
        ...
        <div >
            <ul id="list_kriteria"></ul>
            <ul id="list_sekolah"></ul>
        </div>
        <table id="tabel" >
            <thead>
            <tr id="head" >
    ...
    $("#ahp").click(function () { 
        ...
        var dataSub = {'Fasilitas':['11', '12','13','15'], 'Akademis':['6', '7', '8','9'], 'Biaya':['18', '20']};
        var dataSubname = {'Fasilitas':['Internet', 'Luas Bangunan Sekolah (M2)','Luas Tanah Terbuka (M2)', 'Jumlah Kelas yang terdapat AC'], 
            'Akademis':['Akreditasi', 'Tahun Kurikulum', 'Jumlah Staff (Guru dan Non guru)', 'Jumlah Guru Bersertifikasi'],
            'Biaya':['Uang Gedung','Uang SPP']};

        $.ajax({
            url: "proses_hasil_6_manual.php",
            type: "POST",
            data: { nama: arraylist, 
                    sekolah: arraysekolah,
                    listSub: JSON.stringify(dataSub),
                    listSubName: JSON.stringify(dataSubname)},
